...
size <- 15
theme <- theme_bw(base_size = 15) + theme(plot.title = element_text(hjust = 0.5, size = 22, color="black"),  plot.title.position = 'panel', text = element_text(size = size, color="black"), 
...
```{r}
size <- 28
theme2 <- theme_bw(base_size = 15) + theme(plot.title = element_text(hjust = 0.5, size = size, color="black"),  plot.title.position = 'panel', text = element_text(size = size, color="black"), 
                            axis.text.x = element_text(size = size, color="black"),  axis.text.y = element_text(size = size, color="black"),  
                            axis.title.y = element_text(size = size, color="black"),  axis.title.x = element_text(size = size, color="black"), 
